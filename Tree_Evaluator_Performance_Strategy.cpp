...
//
// Tree_Evaluator_Performance_Strategy
//
Tree_Evaluator_Performance_Strategy::Tree_Evaluator_Performance_Strategy (void)
	:builder_()
{}
...
//
int Tree_Evaluator_Performance_Strategy::calculator (const std::string & infix)
{
	try
	{
		int result=0;
...
//
bool Tree_Evaluator_Performance_Strategy::parse_expr (const std::string & infix)
{
	...
	while(!input.eof())
	{
		...
		// if the token is a number then build number node.
...
//
bool Tree_Evaluator_Performance_Strategy::evaluate_expr (int & result)
{
...
//
bool Tree_Evaluator_Performance_Strategy::is_number (const std::string & token, size_t & count, std::string & token_previous, int & value)
{
