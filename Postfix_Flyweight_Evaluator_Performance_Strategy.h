...
#ifndef _POSTFIX_FLYWEIGHT_EVALUATOR_PERFORMANCE_STRATEGY_H_
#define _POSTFIX_FLYWEIGHT_EVALUATOR_PERFORMANCE_STRATEGY_H_
...
/**
* @class Postfix_Flyweight_Evaluator_Performance_Strategy 
*
* Implementation of Infix to Postfix evaluation and result of Postfix.
*/
class Postfix_Flyweight_Evaluator_Performance_Strategy : public Expr_Evaluator_Strategy
{
public:

	/// Default constructor.
	Postfix_Flyweight_Evaluator_Performance_Strategy (void);

	/// Destructor.
	virtual ~Postfix_Flyweight_Evaluator_Performance_Strategy (void);
...
#endif // !_POSTFIX_FLYWEIGHT_EVALUATOR_PERFORMANCE_STRATEGY_H_
