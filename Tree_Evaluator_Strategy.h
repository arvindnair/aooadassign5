...
#ifndef _TREE_EVALUATOR_STRATEGY_H_
#define _TREE_EVALUATOR_STRATEGY_H_
...
/**
* @class Tree_Evaluator_Strategy
*
* Basic implementation of Tree_Evaluator_Strategy.
*/
class Tree_Evaluator_Strategy : public Expr_Evaluator_Strategy
{
public:

	/// Default constructor.
	Tree_Evaluator_Strategy (void);

	/// Destructor.
	virtual ~Tree_Evaluator_Strategy (void);
...
private:
	...
	*/
	...
	/// Copy Constructor.
	Tree_Evaluator_Strategy (const Tree_Evaluator_Strategy &);

	/// Assignment Operator.
	const Tree_Evaluator_Strategy & operator = (const Tree_Evaluator_Strategy &);
...
#endif // !_TREE_EVALUATOR_STRATEGY_H_
