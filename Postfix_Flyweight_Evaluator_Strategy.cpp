...
#include "Postfix_Flyweight_Evaluator_Strategy.h"                 // for Expression Evaluator.
...
//
Postfix_Flyweight_Evaluator_Strategy::Postfix_Flyweight_Evaluator_Strategy (void)
	:postfix(0),
	iter(postfix),
	factory()
{}
...
//
int Postfix_Flyweight_Evaluator_Strategy::calculator (const std::string & infix)
{
	try
	{
		int result=0;
...
// infix_to_postfix
//
bool Postfix_Flyweight_Evaluator_Strategy::parse_expr (const std::string & infix)
{
...
// evaluate_postfix
//
bool Postfix_Flyweight_Evaluator_Strategy::evaluate_expr (int & result)
{
...
// is_number
//
bool Postfix_Flyweight_Evaluator_Strategy::is_number (const std::string & token, size_t & count, std::string & token_previous, int & value)
{
